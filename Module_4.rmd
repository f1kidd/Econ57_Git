---
title: 'Module 4: How to correct market failures?'
output:
...
### Module 4: How to correct market failures  
...
##
Governmental interventions are often necessary when free markets cannot achieve efficient outcomes:

* Anti-trust laws to correct monopoly
* Lemon laws, disclosure of vehicle history to correct for assymetric information
* Environmental regulations to correct externality from pollution

In fact, some of the most important functions for the government are 1) providing public goods 2) establish and protect property right and market institutions; and 3) correcting market failures
...
## 
So, how should the government intervene to "internalize" the externalities?

## The mining pollution example (from the last module)

Red Keep LLC can mine the uranium with a marginal private cost (MPC) of: **P = Q**. It also generates an marginal external cost (MEC) of **$10** per unit. The marginal social cost is thus **P = Q + 10**. 
...
## 
* There exists an externality (pollution) that is not internalized in the market
* The marginal private cost is lower than the marginal social cost
* Firms overshoots production, sells at a lower price comparing to the efficient outcome

## The tax instrument
One particular way to do so is to put a **pollution tax** on the firm. The tax is often referred to as the **Pigovian tax**, named after A.C. Pigou, an English economist, in the 1920s.

![](figures/m4_pigou.jpeg){height=300px}

## 
The idea is simple:

* Set the tax rate equals to the marginal external cost at the equilibrium
* The polluter has to pay the tax in addition to production costs, thus lower their production
* Market failure is corrected through internalizing the external cost of pollution

## Tax instrument in the mining example

The producer faces a MPC of **P = Q**, plus a pollution tax of **t=10**. Thus the actual cost for the producer becomes

**P = Q + 10**

Equating the supply with the demand of **P = 30 - Q**, we get:
...
## 
![](figures/m4_mining_tax.png){height=450px}
